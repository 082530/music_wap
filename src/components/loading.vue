...
<style scoped>
  ...
  @keyframes rotate {
    ...
    10% { width: 3rem; height: 3rem; }
    66% { width: 1.4rem; height: 1.4rem; }
    100%{ transform: rotate(360deg); width: 3rem; height: 3rem; }
  }

  @keyframes dotsY {
    66% { opacity: .1; width: 1.4rem; }
    77%{ opacity: 1; width: 0; }
  }
  @keyframes dotsX {
    66% { opacity: .1; height: 1.4rem;}
